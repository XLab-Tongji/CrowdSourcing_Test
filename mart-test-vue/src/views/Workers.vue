...
<script>
  ...
  import {getQueryAll, getExperience} from '../axios/api';
  ...
  export default {
    ...
    created() {
      this.workerName = getQueryAll(this).name;
      this.workerEmail = getQueryAll(this).email;
      this.workerMobile = getQueryAll(this).mobile;
      getExperience(this.url, getQueryAll(this).name, this);
    },
    methods: {
